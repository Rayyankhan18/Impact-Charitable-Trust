    ...
    <section id="contact" className="section-padding bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-block bg-impact-blue/10 rounded-full px-4 py-1 text-impact-blue font-medium text-sm mb-4">
            Get in Touch
          </div>
          <h2 className="text-impact-dark mb-4">Contact Us</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-impact-green focus:border-impact-green"
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">
                      Impact Charitable Trust, 123 Charity Lane, Bangalore, Karnataka, India 560001
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">
                      <a href="tel:+919876543210" className="hover:text-impact-yellow">
                        +91 98765 43210
                      </a>
                    </p>
                    <p className="text-gray-600">
                      <a href="tel:+918012345678" className="hover:text-impact-yellow">
                        +91 80 1234 5678
                      </a>
                    </p>
                  </div>
